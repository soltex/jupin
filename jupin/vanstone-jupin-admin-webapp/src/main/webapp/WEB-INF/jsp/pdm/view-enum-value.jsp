...
<form:form action="/pdm/update-enum-value-action" method="post" commandName="attributeForm"  cssClass="required-validate">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title">编辑枚举属性值信息-${attr4EnumValue.attr4Enum.attributeName }</h4>
	</div>
