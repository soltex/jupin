...
public class ProductCategoryServiceImpl extends DefaultBusinessService implements ProductCategoryService {
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#addProductCategory(com.vanstone.jupin.productdefine.ProductCategory)
	 */
	@Override
	public ProductCategory addProductCategory(@NotNull final ProductCategory productCategory) throws CategoryHasProductsException {
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#addProductCategory(com.vanstone.jupin.productdefine.ProductCategory, java.util.Collection)
	 */
	@Override
	public ProductCategory addProductCategory(@NotNull final ProductCategory productCategory, final Collection<AbstractAttribute> attributes) throws CategoryHasProductsException {
		if (productCategory.getParentProductCategory() != null && productCategory.getParentProductCategory().isExistProduct()) {
			throw new CategoryHasProductsException();
		}
		//写入品类信息并更新父品类信息
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#getProductCategoryDetail(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#getRootProductCategoryDetail()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#updateBaseProductCategoryInfo(int, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.Integer)
	 */
	@Override
	public ProductCategory updateBaseProductCategoryInfo(int id,
			String categoryName, String description, String categoryBindPage,
			String formTemplate, Integer sort) {
		// TODO Auto-generated method stub
		return null;
	}

	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#updateProductCategoryCoverImage(int, com.vanstone.jupin.common.entity.ImageBean)
	 */
	@Override
	public ProductCategory updateProductCategoryCoverImage(int id, ImageBean coverImage) throws CategoryHasProductsException{
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#deleteProductCategory(int)
	 */
	@Override
	public void deleteProductCategory(int id)
			throws CategoryHasProductsException,
			CategoryHasSubCategoriesException {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#addAttributeToProductCategory(int, java.util.Collection)
	 */
	@Override
	public void addAttributeToProductCategory(int productCategoryId,
			Collection<AbstractAttribute> attributes)
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#deleteAttributeInProductCategory(int, int)
	 */
	@Override
	public void deleteAttributeInProductCategory(int productCategoryId,
			int attributeId) throws CategoryHasProductsException {
		// TODO Auto-generated method stub

	}

	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#forceDeleteProductCategory(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#refreshAllProductCategories()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#refreshProductCategory(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#refreshRootProductCategory()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#updateExistProductState(int, boolean)
	 */
	@Override
	public void updateExistProductState(int productCategoryID,
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#getProductCategories(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#addAttribute(com.vanstone.jupin.productdefine.attr.AbstractAttribute)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#updateAttr4Text(com.vanstone.jupin.productdefine.attr.Attr4Text)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#updateAttr4Enum(com.vanstone.jupin.productdefine.attr.Attr4Enum)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#getAttribute(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.vanstone.jupin.productdefine.services.ProductCategoryService#getAttributesByIDs(java.util.Collection)
	 */
	@Override
	public Collection<AbstractAttribute> getAttributesByIDs(
